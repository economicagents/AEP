...
**Full testnet deployment:** See [Deployment](deployment.md) for `deploy-base-sepolia.sh`, deployed addresses, and post-deploy steps.
...
- [Deployment](deployment.md) — Base Sepolia and Base Mainnet deployment
